...
class fone{
    ...
    public function __construct($tec, $mat, $btn, $c, $entr){
        $this->setdados($tec, $mat, $btn, $c, $entr);
    }
    function setDados($tec, $mat, $btn, $c, $entr){
        $this->tecnologia = $tec;
        $this->material = $mat;
        $this->botoes = $btn;
        $this->cor = $c;
        $this->entradasP2 = $entr;
    ...
    function conectaTomada(){
        $this->carregador = true;
    }
    function carregar(){
